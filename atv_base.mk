...
PRODUCT_COPY_FILES := \
    device/razer/pearlyn/etc/permissions/tv_core_hardware.xml:system/etc/permissions/tv_core_hardware.xml
...
ifneq ($(USE_OEM_TV_APP),true)
    PRODUCT_PACKAGES += TV
    PRODUCT_COPY_FILES += \
        device/razer/pearlyn/etc/permissions/com.google.android.tv.installed.xml:system/etc/permissions/com.google.android.tv.installed.xml
endif

# To enable access to /dev/dvb*
BOARD_SEPOLICY_DIRS += device/razer/pearlyn/sepolicy
